import { EMAIL, INSTAGRAM_LINK, PHONE_NUMBER } from "@/constants";
      ...
      <div className={styles.topHeaderWrapper}>
        <div className={`${styles.topHeaderContent} container`}>
          <div className={styles.topHeaderContact}>
            <a
              href={INSTAGRAM_LINK}
              className={styles.topHeaderInstagramContactWrapper}
            >
              <svg
            ...
            <a href={`mailto:${EMAIL}`} className={styles.topHeaderMail}>
              {EMAIL}
            </a>
          </div>
